...
- Explicit over magical. Show state, don't hide it.
- Density over whitespace. Respect the operator's attention.
- Small tools, sharp edges. Do one thing, expose the seams.
